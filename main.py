...
# ---------------------------------------------------
TyrKineticsDF = pd.read_csv('Tyrosinase Kinetics Data, Group 3.csv')
...
TyrKinetics_TimeAbsTable.to_csv('Tyrosinase Kinetics, Absorbance-Time Table.csv', index=False)
TyrKinetics_Summary.to_csv('Tyrosinase Kinetics, Summarized Model and Reaction Rates.csv', index=False)
...
TyrMichaelisMenten_Summary.to_csv('Tyrosinase Kinetics, Michaelis-Menten Parameters.csv', index=False)
...
TyrT_TestSummary.to_csv("Tyrosinase Kinetics, T-Test for Slopes and Intercepts in Lineweaver-Burk Plot.csv")
